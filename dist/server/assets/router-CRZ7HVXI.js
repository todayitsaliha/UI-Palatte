...
const appCss = "/assets/styles-uq4t6qoj.css";
...
const $$splitComponentImporter$2 = () => import("./privacy-DyFWtLoC.js");
const Route$2 = createFileRoute("/privacy")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Privacy policy for UI-Palette. Learn how we handle your data and protect your privacy."
    }]
  })
});
const $$splitComponentImporter$1 = () => import("./about-DUoeS12Q.js");
const Route$1 = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Learn about UI-Palette and its creator, Aliha Asad. A tool designed to help developers and designers build accessible, production-ready UI themes from images."
    }]
  })
});
const $$splitComponentImporter = () => import("./index-FDmSULW2.js");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Drop an image, get a WCAG-audited semantic UI palette with live sandbox preview and one-click Tailwind, CSS, JSON & shadcn exports. 100% local, no uploads."
    }]
  })
});
